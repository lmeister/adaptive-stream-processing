...
followed by a brief explanation of the MAPE-K loop in \ref{sub:mape} to conclude this chapter.
    ...
    Self-adaptivity however presents itself as challenging when looked at from a software engineering perspective.
    ...
    % -> Hard to manage multiple MAPE loops, which are good though, especially if independant
