...
followed by a brief explanation of self-adaptive systems to conclude this chapter.
    ...
    Self-adaptive systems are often times based on the \nameref{cha:MAPE-K} [p.\pageref{cha:MAPE-K}].
    ...
    An exemplary application would be a scenario, in which population and food capacities are given and evolving overtime, due to births, deaths, changes in demographics 
