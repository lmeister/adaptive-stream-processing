...
\textbf{Add and explain a few more MAPE Based architectures}
    ...
    Afterwards we will discuss the architecture, talk about the advantages and possible complications. Further we will compare it to its reference architecture in \ref{sec:discussion-edf}.
        ...
        \\
        In order to determine the sequence of the adaptations, Cardellini et al use a \textit{pause-and-resume approach}\cite{Heinze2014CloudbasedDS}. 
        %Erklaerung des pause-and-resume approaches.
        Furthermore, to remain integrity of the stream while adaptations are made, they make use of the \textit{stateful migration protocol}, which they have proposed in \cite{migrationProtocol}.
        %Erklaerung des stateful migration protocols.


        % -> General and no internal policies yet defined
        % ggf hier noch mehr research und krams dazu
