...
subchapter 2.2 defined self-adaptive systems and explains their core features.
    ...
    Note (Will be removed): This subchapter should explain why stream processing is needed, when it is applied, how it works
        ...
        \begin{enumerate}
            ...
            \item \fett{Process and Respond Instantaneously:} 
    ...
    This model has since become the basis or reference architectural pattern for most of the self adaptive systems. [\fett{No Source yet, can't make the claim without source}]
